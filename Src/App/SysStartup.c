...
- @brief __my_startup
-
- @desc Low-level startup routine: initializes RAM and static constructors,
        then jumps to main. Loops forever if main returns.
-
- @param void
- @return void
-----------------------------------------------------------------------------*/
...
- @brief crt_init_ram
-
- @desc Initializes RAM by copying the .data segment from ROM and
        zero-clearing the .bss segment.
-
- @param void
- @return void
-----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
- @brief crt_init_ctors
-
- @desc Calls all global/static constructors located between
        _ctors_begin and _ctors_end during system startup.
-
- @param void
- @return void
-----------------------------------------------------------------------------*/
